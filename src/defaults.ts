      ...
      question: {
        instructions: {
          ...
          decision_boundary: [
            ...
            "A composition-root entry that takes injectable seams (args, cwd, stdout, stderr) and receives only raw process inputs abstains structurally; construction has to bottom out somewhere.",
      ...
      question: {
        instructions: {
          ...
          decision_boundary: [
            ...
            "A composition-root entry that takes injectable seams (args, cwd, stdout, stderr) and receives only raw process inputs abstains structurally.",
