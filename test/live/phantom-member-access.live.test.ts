...
const RULE = "jev/no-phantom-member-access";
...
liveDescribe("phantom member access calibration", () => {
  it("separates a phantom access from a member the owner defines", async () => {
    const positive = await review("phantom-member-positive", [
      "src/tracking.ts",
      "src/storage.ts",
    ]);
    const negative = await review("phantom-member-negative", [
      "src/tracking.ts",
      "src/storage.ts",
    ]);
