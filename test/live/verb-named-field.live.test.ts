...
liveDescribe("verb named field calibration", () => {
  it("judges abstractions carrying verb-named stored fields", async () => {
    const smelly = await review("verb-named-field-smelly", [
      "src/export.ts",
      "src/draft.ts",
    ]);
